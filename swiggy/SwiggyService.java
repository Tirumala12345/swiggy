...
public class SwiggyService {
    public void orderProcess() throws CheckedException {
        ...
        restaurant1.getDishList().add(dish1);
        restaurant1.getDishList().add(dish2);
        restaurant1.getDishList().add(dish3);

        Address address2 = new Address("306", "Madhapur", "hyd", "500084");
        Restaurant restaurant2 = new Restaurant("Pista House", address2);
        restaurant2.getDishList().add(dish1);
        restaurant2.getDishList().add(dish2);
        restaurant2.getDishList().add(dish3);
            ...
            if (foundRestaurant != null) {
                ...
                for (String dishName : dishNames) {
                    ...
                    if (orderedDish != null) {
                        ...
                        System.out.println("Ordered " + orderedDish.getDishName() + " from " + foundRestaurant.getRestaurantName() +
                                " located at " + foundRestaurant.getAddress() +
                                " for Rs:" + orderedDish.getPrice());
                    } else {
